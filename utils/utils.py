...
def color_map(dataset):
    if dataset == 'voc':
        ...
        return ade_cmap()
    elif dataset == "potsdam" or dataset == "vaihingen":
        return isprs_cmap()
    else:
        raise NotImplementedError(f"Missing color palette for dataset: '{dataset}'")


def isprs_cmap():
    return np.array([(255, 255, 255), (0, 0, 175), (0, 175, 255), (0, 255, 0), (255, 175, 0), (175, 0, 0), (0, 0, 0)])
...
def ade_cmap():
    ...
    colors = [[0, 0, 0], [120, 120, 120], [180, 120, 120], [6, 230, 230], [80, 50, 50], [4, 200, 3], [120, 120, 80],
